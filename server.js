...
import setupSystemRoutes from "./server/systemRoutes.js";
...
function normalizeUserShape(userAny) {
  ...
  return {
    ...
    active_transformation_image_url: pd?.active_transformation_image_url,
    active_transformation_settings: pd?.active_transformation_settings,
    active_transformation_expires_at: pd?.active_transformation_expires_at,
  };
}
...
io.on("connection", async (socket) => {
  ...
  const player = {
    ...
    _tokenJTI: user.jti,
    _tokenIAT: user.iat,
    active_transformation_image_url: user.active_transformation_image_url,
    active_transformation_settings: user.active_transformation_settings,
    active_transformation_expires_at: user.active_transformation_expires_at,
  };
